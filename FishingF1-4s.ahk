...
Gui, Add, Text, , 모두 종료키 : %stopkey%
; Gui, Add, Text, , 일시정지/재시작 : %pausekey%
; Gui, Add, Text, , 단축키 비활성화 : %suspendkey%
Gui, Color, 000000
Gui, show, x10 y5 AutoSize

pMsgBox,,, %startkey%에 미끼를 놓습니다`n%item%를 던집니다.`n`n관리자 권한으로 실행하셔야 작동됩니다.`n`n비활성화창(다른창으로 전환)이 되어도`n매크로가 시작된거면 계속 그 창에서 시전됩니다.`n`n이 도움말 창은 10초후 자동으로 사라집니다.,10

f1::
WinGet, active_id, ID, A
MsgBox,,,F1-%item%초 반복 시작...,1
Loop
{
