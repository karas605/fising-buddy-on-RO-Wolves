...
MsgBox,,, F1에 미끼를 놓고 게임에서 컨트롤1 을 누르면 시작됩니다.`n종료키는 컨트롤2 `n`n3초마다 미끼를 던집니다.`n관리자 권한으로 실행하셔야 작동됩니다.`n비활성화창(다른창으로 전환)이 되어도`n매크로가 시작된거면 계속 그 창에서 시전됩니다.`n`n이 도움말 창은 5초후 자동으로 사라집니다.,5
